...
% In the past decades it was shown that materials consisting of graphitic nanoparticles provide such exceptional electrical transport properties as high conductivity and high charge mobility \cite{MARINHO2012351}. One of the most important representatives of this new generation of materials was found to be graphene. Among further developments of graphene based materials were the composites based on a polymeric matrix with graphene particles embedded. This approach enabled enhancing of the electrical conductivity of polymers by several orders of magnitude without compromising other important features, such as the mechanical and optical properties \cite{stankovich_graphene-based_2006}. 

% Taking one step forward a number of LIG based composites were invented and described in the literature. LAMPSe group has developed stretchable and skin-Conformable conductors based on polyurethane covered with LIG for the conductive layer \cite{dallinger_stretchable_2020}. 
